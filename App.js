...
export default function App() {
  ...
  const productData = {
    ...
    pants: {
      image: 'https://placehold.co/600x600/f0f0f0/ffffff?text=Pants',
    },
    accessories: [
      { id: 1, image: 'https://placehold.co/100x100/f0f0f0/ffffff?text=Bag' },
      { id: 2, image: 'https://placehold.co/100x100/f0f0f0/ffffff?text=Sunnies' },
      { id: 3, image: 'https://placehold.co/100x100/f0f0f0/ffffff?text=Scarf' },
      { id: 4, image: 'https://placehold.co/100x100/f0f0f0/ffffff?text=Bag' },
      { id: 5, image: 'https://#hold.co/100x100/f0f0f0/ffffff?text=Sunnies' },
    ],
  };
    ...
    >
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.productSection}>
          <Image
            source={{ uri: productData.top.image }}
        ...
        <View style={styles.productSection}>
          <Image
            source={{ uri: productData.pants.image }}
            style={styles.productImage}
          />
          <View style={styles.navigationButtons}>
            <TouchableOpacity style={styles.navButton}>
        ...
        <View style={styles.accessoriesContainer}>
          {productData.accessories.map((accessory) => (
            <TouchableOpacity key={accessory.id} style={styles.accessoryItem}>
              <Image source={{ uri: accessory.image }} style={styles.accessoryImage} />
            </TouchableOpacity>
          ))}
        </View>
      </View>
